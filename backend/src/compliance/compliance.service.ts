    ...
    paragraphs.push(
      new Paragraph({
        children: [
          ...
          new TextRun({
            text: 'This compliance check was generated by PatentForgeLocal, an open-source AI-powered patent research tool. It is an AI-generated pre-screen intended for discussion with a registered patent attorney. It does not constitute legal advice. Results may contain false positives or negatives, and MPEP citations may be outdated or inaccurate. Every result must be reviewed by a registered patent attorney.',
            color: '6B7280',
            size: 16,
            font: 'Calibri',
          }),
