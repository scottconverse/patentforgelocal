...
export class ClaimDraftService implements OnModuleInit {
  ...
  async getDocxBuffer(projectId: string): Promise<{ buffer: Buffer; filename: string }> {
    ...
    // UPL disclaimer — exact wording per v0.4-SCOPE.md L188.
    paragraphs.push(
      new Paragraph({
        children: [
          new TextRun({
            text: 'DRAFT CLAIM CONCEPTS — NOT REVIEWED BY AN ATTORNEY — NOT FOR FILING',
            bold: true,
            color: 'B45309',
            size: 22,
          }),
    ...
    paragraphs.push(
      new Paragraph({
        children: [
          new TextRun({
            text: 'These are AI-generated research concepts. They must be reviewed, revised, and finalized by a registered patent attorney before any patent application filing.',
            color: 'B45309',
            size: 18,
          }),
        ],
    ...
    paragraphs.push(
      new Paragraph({
        children: [
          ...
          new TextRun({
            text: 'These claims were generated by PatentForgeLocal, an open-source AI-powered patent research tool. They are draft research concepts intended for discussion with a registered patent attorney. They do not constitute legal advice. Claims may be too broad, too narrow, or contain fabricated technical details. Every claim must be reviewed, revised, and finalized by a registered patent attorney before any filing.',
            color: '6B7280',
            size: 16,
            font: 'Calibri',
          }),
    ...
    // Repeating page header — exact wording per v0.4-SCOPE.md L188.
    const draftHeader = new Header({
      children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: 'DRAFT CLAIM CONCEPTS — NOT REVIEWED BY AN ATTORNEY — NOT FOR FILING', color: 'B0B0B0', size: 16, font: 'Calibri', bold: true })] })],
    });
    const draftFooter = new Footer({
      children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: 'Generated by PatentForgeLocal · Not legal advice · Consult a patent attorney before acting', color: 'B0B0B0', size: 14, font: 'Calibri' })] })],
    });

    const doc = new Document({
      creator: 'PatentForgeLocal',
